...
import 'package:vkreta/view/login_signup/forget_change.dart';


class ForgetOtpView extends StatefulWidget {
  ForgetOtpView({Key? key,this.data,this.otp}) : super(key: key);
  var data;
  var otp;
  @override
                      ...
                      setState(() {
                        if (formKey.currentState!.validate()) {
                          if(currentText!=widget.otp.toString()){
                            ...
                            Get.offAll(ForgetChangePassword(data: widget.data,));
                            showErrorToast("PLease set your password");

                            //ApiService().verifyForgetResponse(widget.data.toString());
                          }
